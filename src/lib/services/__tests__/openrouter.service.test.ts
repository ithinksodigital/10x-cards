...
describe("OpenRouterService", () => {
  ...
  describe("generateFlashcards", () => {
    const mockCommand: GenerateFlashcardsCommand = {
      sourceText:
        "This is a comprehensive test text about machine learning algorithms. Machine learning is a subset of artificial intelligence that focuses on algorithms that can learn from data. There are three main types of machine learning: supervised learning, unsupervised learning, and reinforcement learning. Supervised learning uses labeled data to train models, unsupervised learning finds patterns in unlabeled data, and reinforcement learning learns through interaction with an environment.",
      language: "en",
      targetCount: 5,
      userId: "test-user",
