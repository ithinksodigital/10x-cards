...
import { HomeIcon, SparklesIcon, BookOpenIcon, BrainIcon, UserIcon } from "lucide-react";
...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({ isAuthenticated, currentPath = "/" }) => {
