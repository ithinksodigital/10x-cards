      ...
      <DialogContent className={cn("sm:max-w-md", className)}>
        ...
        <div className="space-y-4">
          ...
          {timeRemaining !== null && timeRemaining > 0 && (
            <div className="text-sm text-muted-foreground text-center">Estimated time remaining: {timeRemaining}s</div>
          )}
          ...
          <div className="flex gap-2 pt-2">
            {isFailed ? (
              ...
              <Button onClick={onCancel} className="flex-1" variant="default">
                Continue
              </Button>
            ) : (
              <Button onClick={onCancel} variant="outline" className="flex-1" disabled={isPolling}>
                Cancel
              </Button>
            )}
          </div>
