        ...
        <AlertDescription className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              {onRetry && (
                <Button size="sm" variant="outline" onClick={onRetry} className="text-xs h-6 px-2">
                  Retry
                </Button>
              )}
              <button onClick={onDismiss} className="flex-shrink-0 p-1 hover:bg-black/10 rounded" aria-label="Dismiss">
